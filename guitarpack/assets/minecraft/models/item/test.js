(function () {
    let button;
    Plugin.register('quick_box_uv_layout2', {
        title: 'Quick Box-UV Layout2',
        author: 'Manuel-32',
        ...
        variant: 'both',
        onload() {
            button = new Action('quick_box_uv_layout2', {
                name: 'Quick Box-UV Layout2',
                description: 'Changes UV into Box-UV layout.2',
                icon: 'calendar_view_month',
                click: function () {
